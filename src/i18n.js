...
const resources = {
  en: {
    translation: {
      ...
      h5:"Your History, Your Record",
      f5:"All your past queries and images are saved securely, so you can look back anytime.",
  ...
  hi: {
    translation: {
      ...
      h5:"आपका इतिहास, आपका रिकॉर्ड",
      f5:"आपके सारे पुराने सवाल और तस्वीरें सुरक्षित रखे जाते हैं, ताकि आप कभी भी देख सकें।",
