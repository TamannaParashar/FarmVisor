...
const resources = {
  en: {
    translation: {
      ...
      uploadImage:"Upload photos of crops, pests, or diseases for instant analysis",
      goBack:"Go Back",
      ask:"Ask Your Question",
      getResp:"Get AI Advice",
  ...
  hi: {
    translation: {
      ...
      uploadImage: "तुरंत विश्लेषण के लिए फसलों, कीटों, या रोगों की तस्वीरें अपलोड करें",
      goBack: "वापस जाएँ",
      ask: "अपना प्रश्न पूछें",
      getResp: "एआई से सलाह लें",
